    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item">
                    <a class="nav-link" href="/panelsatker/dashboardsatker">
                    ...
                    <div class="dropdown-menu {{ request()->is(['karyawan','departemen','cabang','datasatker']) ? 'show':'' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a style="font-size: 9px" class="dropdown-item {{ request()->is(['datasatker']) ? 'active':'' }}"
                                   href="/datasatker">
                                    DATA SATKER
                                </a>
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                @foreach($satker_menu as $d)
                                    @if($d->roles!="humas_kanwil" && $d->roles!="superadmin")
                                            <a style="font-size: 9px; " class="dropdown-item active "
                                               href="/datasatker/{{ $d->kode_satker }}/getberita">
                                                {{ $d->name }}
                                            </a>
                                    @endif
                                @endforeach
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['beritasatker/laporanberita','beritasatker/rekapberita'])? 'show':'' }}"
                       href="#navbar-base" data-bs-toggle="dropdown"
                       data-bs-auto-close="false" role="button"
                       aria-expanded="{{ request()->is(['beritasatker/laporanberita','beritasatker/rekapberita'])? 'true':'' }}">
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                   <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-description"
                    ...
                    <div class="dropdown-menu {{ request()->is(['beritasatker/laporanberita','beritasatker/rekapberita'])? 'show':'' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ request()->is(['beritasatker/laporanberita'])? 'active':'' }}"
                                   href="/beritasatker/laporanberita">
                                    Link Berita
                                </a>
                                <a class="dropdown-item {{ request()->is(['beritasatker/rekapberita'])? 'active':'' }}"
                                   href="/beritasatker/rekapberita">
                                    Rekap Link Berita
                                </a>
                            </div>
                        </div>
