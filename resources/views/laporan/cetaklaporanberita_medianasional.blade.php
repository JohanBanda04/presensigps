...
<section class="sheet padding-10mm">
    ...
    <table class="tabelpresensi" style="border-spacing: 0px;
        ...
        @foreach($getberita as $d)
            ...
            @php
                $links_media_lokal = json_decode($d->media_nasional);
            @endphp
        ...
        $tahun = $exp_tgl_input[0];
                ...
                <tr>
                    ...
                    <td align="center" valign="center" style="font-weight: bold; font-size: 15px; background: #cccaca">{{ count($links_media_nasional) }}</td>
                </tr>
            @endforeach
    </table>
