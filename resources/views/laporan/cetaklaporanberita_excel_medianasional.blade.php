    ...
    <table class="tabelpresensi">
        ...
        @foreach($getberita as $key=>$d)
            ...
            <tr>
                ...
                <th style="width: max-content" colspan="10">Link Media Nasional</th>
            </tr>
            @php
        ...
        $bulan = $exp_tgl_input[1];
            ...
            $bulan = substr($bulan,0,2);
                    ...
                    <td colspan="10">{{ $link_nasional }}</td>
                </tr>
            @endforeach
            <tr class="tdcolor">
                @php
                ...
                <td colspan="10" align="center" valign="center" style="font-weight: bold; font-size: 15px; background: #eceaea">{{ count($links_media_nasional) }}</td>
            </tr>
        @endforeach
