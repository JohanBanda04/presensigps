            ...
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                            ...
                            right: 10px; font-size: 0.6rem; z-index: 999">{{ $rekappresensi->jmlhadir }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger" style="position: absolute; top: 3px;
                            right: 10px; font-size: 0.6rem; z-index: 999">{{ $rekapizin->jmlizin }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger" style="position: absolute; top: 3px;
                            right: 10px; font-size: 0.6rem; z-index: 999">{{ $rekapizin->jmlsakit }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger" style="position: absolute; top: 3px;
                            right: 10px; font-size: 0.6rem; z-index: 999">
                        ...
                        @foreach($leaderboard as $leader)
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        <div>
                                            <b>{{ $leader->nama_lengkap }}</b> <br>
                                            <small class="text-muted">{{ $leader->jabatan }}</small>
                                        </div>
                                        <span class="badge {{ $leader->jam_in < "07:00:00" ? 'bg-success':'bg-danger'}}">
                                            {{ $leader->jam_in }}
                                        </span>
                                    </div>
                                </div>
